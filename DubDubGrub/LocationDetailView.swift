...
struct LocationDetailView: View {
    ...
    var body: some View {
        ...
        VStack(spacing: 16) {
            ...
            DescriptionView(text: "This is a text description. This is a text description. This is a text description. This is a text description. This is a text description.")
